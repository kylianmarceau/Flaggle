...
import { codesCategory, flagsCategory, pickCountryCategory, shapesCategory } from "./builtins";
...
export const soloPromptCategories: readonly PromptCategory[] = [flagsCategory, shapesCategory, codesCategory];
